...
final class QRCode
{
    ...
    public function __construct(string $data, int $errorCorrectionLevel = ErrorCorrectionLevel::M, ?int $version = null)
    {
        if ($data === '') {
    ...
    {
        if ($this->matrix === null) {
            $this->matrix = Encoder::encode($this->data, $this->errorCorrectionLevel, $this->version);
        }
    ...
    /**
     * @param array{level?: int, size?: int, margin?: int, foreground?: string, background?: string} $options
     */
    public static function svg(string $data, array $options = []): string
    {
        $qr = new self($data, $options['level'] ?? ErrorCorrectionLevel::M);
    ...
    /**
     * @param array{level?: int, size?: int, margin?: int, foreground?: int, background?: int} $options
     */
    ...
    /**
     * @param array{level?: int, size?: string, foreground?: string, background?: string} $options
     */
    ...
    /**
     * @param array{level?: int, dark?: string, light?: string, margin?: int} $options
     */
